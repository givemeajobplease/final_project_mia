...
//onclick STAMP show all STAMP variables hide all HUB variables
function runSTAMP(){
    
}
//onclick GAME show all GAME variables hide all HUB variables
function runGAME(){
    
}


//onclick DOTS show all DOTS variables hide all HUB variables
function runDOTS(){
